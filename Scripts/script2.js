...
(function (_, $, Drupal, drupalSettings) {
  ...
  (function ($, Drupal, drupalSettings) {
      ...
      Drupal.behaviors.filter_toggle = {
          attach: function (context, settings) {
              //$('#edit-field-road-target-id--2').multiselect({
              //	nonSelectedText: 'Select Road',
        ...
        //    which means this will match:  'edit-field-road-target-id-randomstring' 
              //$("[id^=edit-field-road-target-id]").multiselect({
              //	nonSelectedText: 'Select Road',
              //	enableFiltering: true,
              //	enableCaseInsensitiveFiltering: true,
              //	buttonWidth:'100%',
              //});
              //$("[id^=edit-field-county-target-id--2]").multiselect({
              //	nonSelectedText: 'Select County',
              //	enableFiltering: true,
              //	enableCaseInsensitiveFiltering: true,
              //	buttonWidth:'100%'
              //});
              //$("[id^=edit-field-county-target-id]").multiselect({
              //	nonSelectedText: 'Select County',
              //	enableFiltering: true,
              //	enableCaseInsensitiveFiltering: true,
              //	buttonWidth:'100%'
              //});
              //$("[id^=edit-field-county-target-id-study--2]").multiselect({
              //	nonSelectedText: 'Select County',
              //	enableFiltering: true,
              //	enableCaseInsensitiveFiltering: true,
              //	buttonWidth:'100%'
              //});
              //$("[id^=edit-field-county-target-id-study]").multiselect({
              //	nonSelectedText: 'Select County',
              //	enableFiltering: true,
              //	enableCaseInsensitiveFiltering: true,
              //	buttonWidth:'100%'
  ...
  (function ($, Drupal, drupalSettings) {
    ...
    Drupal.behaviors.front_tabs = {
      attach: function (context, settings) {
        $('#block-views-block-slideshow-block-3 #widget_pager_bottom_slideshow-block_3 .views_slideshow_pager_field_item').each(function(){
            if($(this).hasClass('active')) {
              $(this).find('button').attr('aria-selected','true');
            }
            $(this).find('a').attr('tabindex', '-1');
        });
        $('#block-views-block-slideshow-block-3 #widget_pager_bottom_slideshow-block_3 .views_slideshow_pager_field_item button')
          .once()
          .on('click touch', function() {
          
          var clicked_tab_aria = $(this).find('button').attr('aria-selected');
          $('#block-views-block-slideshow-block-3 #widget_pager_bottom_slideshow-block_3 .views_slideshow_pager_field_item')
            .each(function(){
  
          });
          if (typeof clicked_tab_aria == 'undefined' || clicked_tab_aria == 'false') {
    ...
    Drupal.behaviors.filter_close = {
      attach: function (context, settings) {
        $('figure.align-center').each(function(){
          var w = $(this).find('div div img').width();
          $(this).find('figcaption').width(w);
        });
        $('form#airport-selection select#airport-options').change(function() {
          var s = $(this).val();
          $('form#airport-selection').attr('action', s);
        });
        $('form#county-selection select#county-options').change(function() {
          var s = $(this).val();
          $('form#county-selection').attr('action', s);
        });
      }
    }
  })(jQuery, Drupal, drupalSettings);;